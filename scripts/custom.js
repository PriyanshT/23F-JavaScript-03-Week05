...
btn.onclick = function () {
    displayMessage('This is a very important message! Please read carefully.', 'warning');
};
...
function displayMessage(msgText, msgType) {
    ...
    msgPanel.textContent = msgText; // <p class="msgPanel">This is some information</p>
    ...
    // STEP 4c: Add this new button element as a child of the msgPanel paragraph element 
    // created earlier
    msgPanel.appendChild(closeBtn);
    // STEP 5: Build an onclick event handler for the close button that removes 
    // the msgPanel from the DOM entirely using the removeChild() method
    ...
    /* STEP 7b: Build an if/elseif/else statement (or a switch) below that adds a class of either 'error', 
        'warning', or 'default' to the msgPanel element using the built-in method classList.add() - refer to 
        the above CSS to see the styles associated with each of these classes */
    if (msgType === "error") {
